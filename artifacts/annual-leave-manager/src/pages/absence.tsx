...
import { useGetEmployees, useCreateAbsence, getGetDashboardSummaryQueryKey, getGetLeaveRequestsQueryKey, getGetEmployeesQueryKey } from '@workspace/api-client-react';
...
export default function AbsencePage() {
  ...
  if (submitted) {
    return (
      <div>
        <PageHeader eyebrow="등록 완료" title="부재 일정이 등록되었습니다" />
        <div className="mx-auto max-w-[640px] px-5 py-12 sm:px-8 md:py-16">
          <div className="surface animate-rise p-8 text-center sm:p-12">
            ...
            <h2 className="mt-6 text-xl font-extrabold tracking-[-.05em]">부재 등록 완료</h2>
            ...
            <div className="mx-auto mt-6 max-w-sm divide-y divide-[hsl(var(--border))] rounded-xl border border-[hsl(var(--border))] text-left">
              ...
              <ConfirmRow label="부재 기간" value={`${startDate} — ${endDate}`} />
    ...
    <div>
      ...
      <div className="mx-auto grid max-w-[1060px] gap-5 px-5 py-7 sm:px-8 md:grid-cols-[1fr_300px] md:py-10">
        <div className="surface p-5 sm:p-8">
          <form onSubmit={submit} data-testid="form-absence-registration">
            <div className="mb-7">
              <div className="eyebrow mb-2">01 · 대상자 선택</div>
              <h2 className="text-lg font-extrabold tracking-[-.04em]">누구의 부재인가요?</h2>
            </div>
            ...
            {!employeesQuery.isLoading && !employeesQuery.isError && (
              <>
                ...
                <div className="mb-8">
                  ...
                  <h2 className="mb-4 text-lg font-extrabold tracking-[-.04em]">언제부터 부재하나요?</h2>
                ...
                <div className="mb-7">
                  ...
                  <h2 className="mb-4 text-lg font-extrabold tracking-[-.04em]">관리자 기록을 남겨주세요</h2>
                  <textarea 
                    value={reason} 
                    onChange={(event) => setReason(event.target.value)} 
                    data-testid="textarea-absence-reason" 
                    placeholder="부재 사유 (예: 공가, 병가, 외부 교육 참석 등)를 명확히 적어 주세요." 
                ...
                <div className="flex items-center justify-between gap-4 border-t border-[hsl(var(--border))] pt-5">
                  ...
                  <ActionButton 
                    testId="button-submit-absence-registration" 
                    onClick={() => { 
                      const form = document.querySelector<HTMLFormElement>('[data-testid="form-absence-registration"]'); 
                      form?.requestSubmit(); 
                    }} 
        ...
        <aside className="space-y-4">
          <div className="surface bg-[hsl(var(--primary))] p-5 text-[hsl(var(--primary-foreground))]">
            ...
            <div className="text-[11px] font-bold opacity-70">관리자 부재 등록 안내</div>
            <ul className="mt-3 space-y-3 text-[12px] font-semibold leading-5">
              <li>• 구성원이 개인 연차를 사용하는 것이 아닌, 기타 사유로 부재 시 관리자가 직접 기록하는 기능입니다.</li>
