...
import { LeaveType, useGetMyEmployee } from '@workspace/api-client-react';
...
export default function ApplyPage() {
  const employeeQuery = useGetMyEmployee();
  ...
  const submit = (event: FormEvent<HTMLFormElement>) => {
    ...
    setError('');
    if (!selectedEmployee || !startDate || !endDate || !reason.trim()) { setError('본인 정보, 기간, 사유를 모두 확인해 주세요.'); return; }
